...
<img
src="01_pokemon_sprites_files/figure-commonmark/cell-14-output-2.png"
width="708" height="708" />

## Uploading to Hugging Face

It’s both easier and faster to use HuggingFace to download the data than
to scrape the pokemon website every time.

------------------------------------------------------------------------

### download_pokemon_from_hf

>  download_pokemon_from_hf (repo_id:str)

*Download Pokemon sprites from Hugging Face Hub (cached automatically)*

------------------------------------------------------------------------

### upload_pokemon_to_hf

>  upload_pokemon_to_hf (repo_id:str, token:str=None)

*Upload Pokemon sprites to Hugging Face Hub*

Hugging Face automatically handles all the caching — files are
downloaded once and reused on subsequent calls.
