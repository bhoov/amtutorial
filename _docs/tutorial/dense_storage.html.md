...
```
    ...
    NameError                                 Traceback (most recent call last)
    Cell In[1], line 2
          1 # DenseAM: Increase the number of stored patterns!
    ...
    Traceback (most recent call last):
      ...
      File "<ipython-input-1-c5fd230bb2b8>", line 2, in <module>
        Xi = data[eevee_pichu_idxs]
...
```
    ...
    Traceback (most recent call last):
      ...
      File "<ipython-input-1-e0810a1371ac>", line 6, in <module>
