...
- [**PDF of Dima's slides**](./resources/dima--ICML_tutorial_slides.pdf){download="dima--ICML_tutorial_slides.pdf"} ([raw slides](./resources/dima--ICML_tutorial_slides.key) needs Keynote)
- [**PDF of Ben's slides**](./resources/ben--ICML_tutorial_slides.pdf){download="ben--ICML_tutorial_slides.pdf"} (to use the [raw slides](./resources/ben--ICML_tutorial_slides.zip), unzip and open the `index.html` file in a local browser)
- [**PDF of Pari's slides**](./resources/pari--ICML_tutorial_slides.pdf){download="pari--ICML_tutorial_slides.pdf"} ([raw slides](./resources/pari--ICML_tutorial_slides.pptx) needs PowerPoint)
:::
