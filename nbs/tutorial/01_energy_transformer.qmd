...
```{python}
from amtutorial.eqx_utils import monkey_patch
monkey_patch() # Make model surgery easier
```

The model itself is pretty small ~20MB. We load the state dict from a saved .npz file as follows:
