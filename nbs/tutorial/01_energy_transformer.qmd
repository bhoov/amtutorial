...
```{python}
def inpaint_image(iet, img, n_mask, key, nsteps=12, step_size=0.1):
...
```{python}
#| echo: false
#| fig-label: Sampling the stored patterns in the Hopfield Network, sorted by frequency content
