...
#| echo: false
nh, nw = 2, 5
plt.imshow(rearrange(imgs[:nh*nw], "(nh nw) c h w -> (nh h) (nw w) c", nh=nh, nw=nw))
plt.axis('off')
...
#| echo: false
pad_width = 1
padded_patches = np.pad(patched_img, ((0,0), (0,0), (pad_width,pad_width+1), (pad_width,pad_width+1)), mode='constant')
plt.imshow(rearrange(patcher.unpatchify(padded_patches), "c h w -> h w c"))
plt.axis('off')
