...
def inpaint_image(et, img, n_mask, key, nsteps=12, step_size=0.1):
    ...
    recons_img = iet(img, mask, nsteps=nsteps, step_size=step_size)
    
    return masked_img, recons_img
...
masked_imgs, recons_imgs = jax.vmap(inpaint_image, in_axes=(None, 0, None, 0))(iet, og_imgs, 100, keys)
