...
```{python}
# @title PyTorch Code for ScoreNet
@torch.no_grad()
...
```{python}
# @title Sample Data from The Models We Trained
generated_set = []
...
## 6. Potential Energy of Generated and Data Samples
...
# 7. Sample from our trained models and Visualization of the Energy
...
# 8. Exact Energy from Dense Associative Memory
